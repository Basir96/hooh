...
### INSTALL SCRIPT
<pre><code>apt install -y wget screen && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/basir96/hooh/ipuk/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>
