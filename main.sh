...
MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/basir96/izin/ipuk/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
        TIMEDATE
    else
...
KYTPROJECT() {
    curl -sS https://raw.githubusercontent.com/basir96/izin/ipuk/ip >/root/tmp
...
apete_eee() {
    ...
    if [ -f /home/needupdate ]; then
        ...
        green "Contact telegram https://t.me/novanthekillz"
        sleep 8
        exit 0
    fi
}
...
KEY="6144588998:AAHWJPu36FfB2GPqWayJPUKmpmkAf6Bo1ds"
URL="https://api.telegram.org/bot$KEY/sendMessage"
REPO="https://raw.githubusercontent.com/basir96/hooh/ipuk/"
CDNF="https://raw.githubusercontent.com/basir96/hooh/ipuk"
...
function finish(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/basir96/izin/ipuk/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/basir96/izin/ipuk/ip | grep $MYIP | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/novanthekillz"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/vpnseduluran9699/1"}]]}'
